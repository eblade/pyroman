" pyroman.vim (formerly named Wikipedia.vim)
" 
" Vim syntax file
...
sy match pyromanObject /^[A-Z]\w*:/
sy match pyromanParam /^[a-z]\w*:/
...
HtmlHiLink wikiH1 htmlBold
HtmlHiLink wikiH2 htmlBold
HtmlHiLink wikiH3 htmlBold
HtmlHiLink wikiH4 htmlBold
HtmlHiLink wikiH5 htmlBold
HtmlHiLink wikiH6 htmlBold
...
HtmlHiLink pyromanObject      htmlBold
HtmlHiLink pyromanParam       htmlComment
