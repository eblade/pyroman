...
from GnarpUtils import getkey, varsub

## @class Generic
#
# Describes a Generic Gnarp Object with standard methods. All special object
# classes must inherit the GnarpGeneric class.
class Generic:

    ## @fn __init__
    #
    # GnarpGeneric initialisation
    #
    ...
    def upgrade(self):
        ...
        if class_name == 'vim':
            return False
        module_name = ''.join(['Gnarp',self.object_name])
